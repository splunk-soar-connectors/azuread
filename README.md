...
This table lists the configuration variables required to operate Azure AD Graph. These variables are specified when configuring a Azure AD Graph asset in Splunk SOAR.
